        ...
        {Industries.map((industryName, index) => {
          ...
          return (
            <motion.button
              ...
              className={`p-6 rounded-2xl border-2 text-center transition-all duration-300 backdrop-blur-sm ${
                selectedIndustry === id
            ...
            >
              ...
              <div
                className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-r ${gradient} flex items-center justify-center text-2xl text-white font-bold shadow-md`}
              >
              ...
              <p
                className={`font-semibold bg-gradient-to-r ${gradient} bg-clip-text text-transparent drop-shadow-sm`}
                style={{
