...
function CheckoutForm({ priceId, plan, isLoading: isPlanLoading, showPlanSelection, currentPlanId, isPlanChanged }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await createPaymentIntent({
        priceId,
        currency: "PKR",
        planId: currentPlanId, // Always send the planId
      }).unwrap();
    ...
    <Card className="shadow-xl border border-gray-200">
      ...
      <CardContent className="p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button
            type="submit"
            disabled={!stripe || isLoading || !priceId || !acceptedTerms}
...
export default function PaymentForm({ priceId, plan, isLoading, showPlanSelection, currentPlanId, isPlanChanged }) {
  return (
