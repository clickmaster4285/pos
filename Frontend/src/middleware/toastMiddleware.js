    ...
    if (allowedEndpoints.includes(endpoint)) {
      const toastTypes = {
        ...
        createTable: {
          type: 'success',
          title: 'Table Created',
          description: 'Your table has been placed successfully.',
          bgColor: 'bg-green-100',
          textColor: 'text-green-800',
          icon: 'check-circle',
          actions: [],
        ...
        updateTable: {
          ...
          description: 'Waiter has been updated.',
          bgColor: 'bg-green-100',
          textColor: 'text-green-800',
          icon: 'check-circle',
          actions: [],
        ...
        markOccupied: {
          type: 'success',
          title: 'Mark Occupied',
          description: 'Table has been marked occupied.',
          bgColor: 'bg-green-100',
          textColor: 'text-green-800',
          icon: 'check-circle',
          actions: [],
        ...
        cancelReservation: {
          ...
          description: 'Table reservation has been cancelled successfully.',
          bgColor: 'bg-green-100',
          textColor: 'text-green-800',
          icon: 'check-circle',
          actions: [],
