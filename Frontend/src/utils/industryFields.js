...
export const getProductFields = (industry) => {
  ...
  switch (i) {
    case "restaurant":
      return [
        { name: "sellingPrice", label: "Selling Price", type: "number", min: 1 },
        { name: "ingredients", label: "Ingredients", type: "ingredients-array" },
        { name: "preparationTime", label: "Preparation Time (min)", type: "number", min: 1 },
    ...
    case "fashion":
      return [
        ...
        { name: "subCategoryName", label: "Sub Category", type: "select", options: []  },
    ...
    case "pharmacy":
      return [
        ...
        { name: "form", label: "Form", type: "select", options: ["Tablet", "Capsule", "Syrup", "Injection", "Ointment", "Drops"] },
        { name: "prescriptionRequired", label: "Prescription Required", type: "checkbox" },
    ...
    case "electronics":
      return [
        ...
        { name: "warranty", label: "Warranty (months)", type: "number", min: 0 },
    ...
    case "general shop":
      return [
        ...
        { name: "vendor", label: "Vendor", type: "select-vendor" },
        { name: "brand", label: "Brand", type: "text" },
        { name: "weight", label: "Weight (kg)", type: "number", min: 0.01, step: 0.01 },
        { name: "dimensions", label: "Dimensions (LxWxH cm)", type: "text" },
        { name: "shelfLife", label: "Shelf Life (days)", type: "number", min: 1 },
